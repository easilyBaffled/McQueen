    ...
    <div className="mission-page">
      <div className="mission-header">
        <div className="mission-header-text">
          ...
          <p className="page-subtitle">Test your NFL knowledge by predicting player price movements</p>
        </div>
        <button 
            ...
            <div className="help-content">
              <div className="help-step">
                ...
                <div className="help-step-text">
                  ...
                  <p>Choose 3 players you think will go <span className="text-up">UP</span> (risers) and 3 you think will go <span className="text-down">DOWN</span> (fallers).</p>
                </div>
              </div>
              ...
              <div className="help-step">
                ...
                <div className="help-step-text">
                  <h4>Use the News</h4>
                  <p>Check player headlines for clues. Injuries, big games, and trade rumors all affect prices!</p>
                </div>
              </div>
              ...
              <div className="help-step">
                ...
                <div className="help-step-text">
                  <h4>Compete & Climb</h4>
                  <p>Your accuracy is scored and ranked. Beat other traders to climb the leaderboard!</p>
                </div>
              </div>
              
              <div className="help-tip">
                <strong>💡 Pro Tip:</strong> Look for players with recent news that could boost or hurt their value tomorrow.
              </div>
            </div>
          </motion.div>
        )}
