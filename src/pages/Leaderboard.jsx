...
const fakeTraders = [
  { id: 1, name: 'GridironGuru', portfolioValue: 15420.50, weeklyGain: 18.4 },
  { id: 2, name: 'TDKing2024', portfolioValue: 14890.25, weeklyGain: 15.2 },
  { id: 3, name: 'FantasyMVP', portfolioValue: 14210.00, weeklyGain: 12.8 },
  { id: 4, name: 'StockJock', portfolioValue: 13850.75, weeklyGain: 11.5 },
  { id: 5, name: 'RookieTrader', portfolioValue: 13420.00, weeklyGain: 9.2 },
  { id: 6, name: 'ChartChaser', portfolioValue: 12980.50, weeklyGain: 7.8 },
  { id: 7, name: 'EndZoneElite', portfolioValue: 12540.25, weeklyGain: 6.1 },
  { id: 8, name: 'PigSkinPro', portfolioValue: 12100.00, weeklyGain: 4.5 },
  { id: 9, name: 'NFLNerd', portfolioValue: 11650.75, weeklyGain: 2.9 },
  { id: 10, name: 'BullMarketBob', portfolioValue: 11200.00, weeklyGain: 1.2 },
];
...
export default function Leaderboard() {
  ...
  // Find user's rank
  const userRank = fakeTraders.findIndex((t) => userValue > t.portfolioValue) + 1;
    ...
    <div className="leaderboard-page">
      ...
      <div className="user-rank-card">
        ...
        <div className="rank-details">
          ...
          <span className="rank-value">${userValue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
        </div>
        <div className={`rank-change ${userGain >= 0 ? 'positive' : 'negative'}`}>
        ...
        {fakeTraders.map((trader, index) => (
          ...
          >
            ...
            <span className="col-value">
              ${trader.portfolioValue.toLocaleString('en-US', { minimumFractionDigits: 2 })}
            </span>
            <span className={`col-gain ${trader.weeklyGain >= 0 ? 'text-up' : 'text-down'}`}>
              {trader.weeklyGain >= 0 ? '+' : ''}{trader.weeklyGain.toFixed(1)}%
            </span>
          </motion.div>
        ))}
        ...
        {displayRank > 10 && (
          <>
            ...
            >
              ...
              <span className={`col-gain ${userGain >= 0 ? 'text-up' : 'text-down'}`}>
                {userGain >= 0 ? '+' : ''}{userGain.toFixed(1)}%
              </span>
            </motion.div>
          </>
