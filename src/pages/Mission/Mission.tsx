...
export default function Mission() {
  ...
  return (
    <div className={styles['mission-page']} data-testid="mission-page">
      <div className={styles['mission-header']}>
        <div className={styles['mission-header-text']}>
          <h1 className={styles['page-title']}>Daily Predictions</h1>
          <p className={styles['page-subtitle']}>
            Test your NFL knowledge by predicting player price movements
          </p>
        </div>
        <button className={styles['help-toggle']} data-testid="help-toggle" onClick={() => setShowHelp(!showHelp)}>
        ...
        {showHelp && (
          ...
          >
            <div className={styles['help-content']}>
              <div className={styles['help-step']}>
                <div className={styles['help-step-icon']}>🎯</div>
                <div className={styles['help-step-text']}>
