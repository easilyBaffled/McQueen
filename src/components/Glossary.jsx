...
const glossaryTerms = [
  {
    term: 'Portfolio',
    definition: 'Your collection of player investments. When you buy shares of a player, they go into your portfolio.',
    example: 'If you own shares of Patrick Mahomes and Josh Allen, they are both in your portfolio.',
  },
  {
    term: 'Shares',
    definition: 'Units of ownership in a player. You can buy multiple shares of the same player.',
    example: 'Buying 5 shares of a player at $100 each costs $500 total.',
  },
  {
    term: 'Price',
    definition: 'The current value of one share of a player. Prices change based on performance and news.',
    example: 'If a player scores 3 touchdowns, their price might go from $120 to $135.',
  },
  {
    term: 'Risers',
    definition: 'Players whose price has increased. Shown in green with an up arrow (▲).',
    example: 'A player who went from $80 to $92 is a "riser" with +15% gain.',
  },
  {
    term: 'Fallers',
    definition: 'Players whose price has decreased. Shown in red with a down arrow (▼).',
    example: 'A player who got injured and dropped from $100 to $85 is a "faller".',
  },
  {
    term: 'Watchlist',
    definition: 'Players you want to keep an eye on without buying. Like a favorites list.',
    example: 'Add players to your watchlist to track their price before deciding to buy.',
  },
  {
    term: 'Buy',
    definition: 'Purchase shares of a player using your virtual cash. You profit if their price goes up.',
  ...
  {
    term: 'Total Value',
    definition: 'Your cash plus the current value of all your player shares combined.',
    example: '$5,000 cash + $6,000 in player shares = $11,000 total value.',
  },
  {
    term: 'Gain/Loss %',
    definition: 'How much you\'ve made or lost on a player since buying, shown as a percentage.',
          ...
          >
            <div className="glossary-header">
              <div className="glossary-title-row">
                <h2 className="glossary-title">📖 Trading Terms</h2>
