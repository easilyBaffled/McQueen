                ...
                {currentStep.highlight === 'colors' && (
                  <div className="onboarding-demo">
                    <div className="demo-price up">
                      <span className="demo-label">Going Up</span>
                      <span className="demo-value">▲ +5.2%</span>
                    </div>
                    <div className="demo-price down">
                      <span className="demo-label">Going Down</span>
                      <span className="demo-value">▼ -3.1%</span>
                    </div>
                  </div>
                )}
