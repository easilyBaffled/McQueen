...
export function SimulationProvider({ children }) {
  ...
  const [espnNews, setEspnNews] = useState([]);
  const [espnLoading, setEspnLoading] = useState(false);
  const [espnError, setEspnError] = useState(null);
  const [espnPriceHistory, setEspnPriceHistory] = useState({});
  const [processedArticleIds, setProcessedArticleIds] = useState(new Set());
